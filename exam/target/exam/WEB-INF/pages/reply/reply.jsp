    ...
    <header class="mdl-layout__header mdl-layout__header--scroll mdl-color--grey-50">
        <div class="mdl-layout__header-row">
            ...
            <a class="mdl-layout-title mdl-navigation__link mdl-color-text--pink-400"
               href="/exam/post/postContent-<%=request.getParameter("replyPostId")%>">Blogger</a>
            ...
            <nav class="mdl-navigation">
                <c:choose>
                    <c:when test="${username != null}">
                        <a href="/exam/user/listUserInfo?username=${username}" class="mdl-navigation__link mdl-color-text--pink-400">
                                ${username}
                        </a>
                        <c:if test="${username == 'admin'}">
                            <a href="/exam/admin/manageCenter" class="mdl-navigation__link mdl-color-text--black">登入管理后台</a>
                        </c:if>
                        <a href="/exam/user/loginOut" class="mdl-navigation__link mdl-color-text--black">注销</a>
                    </c:when>
                    <c:when test="${username == null}">
                        <a href="/exam/user/userLogin" class="mdl-navigation__link mdl-color-text--pink-400">登录</a>
                        <a href="/exam/userRegister" class="mdl-navigation__link mdl-color-text--pink-400">注册</a>
                    </c:when>
                </c:choose>
            </nav>
        </div>
                ...
                <div class="mdl-cell--4-col">
                    <div class="mdl-card mdl-shadow--2dp center card-width">
                        ...
                        <div class="mdl-card__subtitle-text">
                            <form action="/exam/reply/addReply" method="post">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="mdl-button mdl-js-button mdl-button--raised"
                                               href="/exam/post/postContent-<%=request.getParameter("replyPostId")%>">
                                                取消
                                            </a>
                                        </td>
                                    </tr>
