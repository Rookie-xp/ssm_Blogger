...
<div class="mdl-layout mdl-js-layout">
    <header class="mdl-layout__header mdl-layout__header--scroll mdl-color--grey-50">
        <div class="mdl-layout__header-row">
            <!-- Title -->
            <a class="mdl-layout-title mdl-navigation__link mdl-color-text--pink-400" href="/exam/admin/manageBoard">Blogger</a>
        ...
        <div class="page-content">
            ...
            <div class="mdl-grid">
                ...
                <div class="mdl-cell--4-col">
                    <form action="/exam/admin/updateBoard" method="post">
                            ...
                            <tr>
                                <td>
                                    <a class="mdl-button mdl-js-button mdl-button--raised mdl-color--pink-400 mdl-color-text--white"
                                       href="/exam/admin/updateBoard" type="submit" name="submit">修改</a>
                                </td>
                                <td>
                                    <a class="mdl-button mdl-js-button mdl-button--raised"
                                       href="/exam/admin/manageBoard">返回</a>
                                </td>
                            </tr>
                        </table>
                    </form>
